    ...
    return (
        <div className="home__data">
            ...
            <p className="home__description">
                Desarrollador full stack con entusiasmo por aprender y crecer en la industria tecnológica, con un enfoque particular en ciberseguridad. Comprometido con la excelencia y la mejora continua.
            </p>
